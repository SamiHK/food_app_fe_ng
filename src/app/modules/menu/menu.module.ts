...
import { AlertModule, BadgeModule, ButtonGroupModule, ButtonModule, CardModule, FormModule, GridModule, ImgModule, ListGroupModule, NavbarModule, NavModule, SidebarModule, SpinnerModule, TableModule } from '@coreui/angular';
